        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ClientCode = table.Column<int>(type: "INTEGER", nullable: true),
                    ClientTypeId = table.Column<int>(type: "INTEGER", nullable: true),
                    ClientAreaId = table.Column<int>(type: "INTEGER", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Clients_ClientAreas_ClientAreaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BLZ = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BankAccounts_Currencies_DefaultCurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOcrProcessed = table.Column<bool>(type: "INTEGER", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExpenseInvoices_Businesses_BusinessId",
                        column: x => x.BusinessId,
                        principalTable: "Businesses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExpenseInvoices_Currencies_CurrencyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientAreaId = table.Column<int>(type: "INTEGER", nullable: true),
                    IsForServices = table.Column<bool>(type: "INTEGER", nullable: false),
                    DefaultTaxRateId = table.Column<int>(type: "INTEGER", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accounts_ClientAreas_ClientAreaId",
                        column: x => x.ClientAreaId,
                        principalTable: "ClientAreas",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Accounts_TaxRates_DefaultTaxRateId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    ExpenseInvoiceId = table.Column<int>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Taxes_Accounts_AccountId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Taxes_TaxRates_TaxRateId",
                        column: x => x.TaxRateId,
                        principalTable: "TaxRates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_ClientAreaId",
                table: "Accounts",
                column: "ClientAreaId");

            migrationBuilder.CreateIndex(
                name: "IX_Accounts_DefaultTaxRateId",
                table: "Accounts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BankAccounts_DefaultCurrencyId",
                table: "BankAccounts",
                column: "DefaultCurrencyId");

            migrationBuilder.CreateIndex(
                name: "IX_Clients_ClientAreaId",
                table: "Clients",
                column: "ClientAreaId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseInvoices_BusinessId",
                table: "ExpenseInvoices",
                column: "BusinessId");

            migrationBuilder.CreateIndex(
                name: "IX_ExpenseInvoices_CurrencyId",
                table: "ExpenseInvoices",
                column: "CurrencyId");
